...
<section className='last_container'>
   ...
   <p className='first_para'>asks for your donation for the River Floods in Bangladesh</p>
   ...
   <h2 className='footer_header'>Be Humble</h2>
       <p className='footer_para'>I’m gonna do it</p>
